import lessonsPopupStyles from '../../../../../../styles/popup/contentType/lessons/lessons.module.css'
...
const Lessons = ({popup}) => {
    ...
    const radios = [{text:'Группа'},{text: 'Индивидуальное'}].map((radio,index)=>(
        <div className={lessonsPopupStyles.inputRadio} onClick={()=>radiosHandler(index+1)}>
            <div className={`${lessonsPopupStyles.radio} ${index+1 === functions.lesson_type && lessonsPopupStyles.checked}`}></div>
    ...
    return (
        <div className={lessonsPopupStyles.lessons}> 
            <div className={lessonsPopupStyles.close} onClick={closePopup}>
            ...
            <div className={lessonsPopupStyles.radio}>
                <p>Тип</p>
                <div className={lessonsPopupStyles.radioContainer}>
                    {radios}
                </div>
            </div>
            <div className={lessonsPopupStyles.name}>
                <p>Название</p>
                <input 
                    name='lesson_name'
                    className={lessonsPopupStyles.input}
                    onChange={inputHandler}
                />
            </div>
            <div className={lessonsPopupStyles.color}>
                <p>Цвет</p>
                <Select 
                    className={lessonsPopupStyles.select}
            ...
            <div className={lessonsPopupStyles.students}>
                <p>Ученики</p>
                <Select 
                    className={lessonsPopupStyles.select}
                    placeholder={''}
            ...
            <div className={lessonsPopupStyles.teachers}>
                <p>Педагоги</p>
                <Select 
                    className={lessonsPopupStyles.select}
                    placeholder={''}
            ...
            <div className={lessonsPopupStyles.buttons}>
                <button onClick={setLesson} className={lessonsPopupStyles.save}>Добавить</button>
            </div>
        </div>
    )
}
